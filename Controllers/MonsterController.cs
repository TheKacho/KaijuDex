...
namespace KaijuDex.Controllers
{
    public class MonsterController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Creator,BirthYear")] Monster monster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Creator,BirthYear")] Monster monster)
        {
            if (id != monster.ID)
            {
                return NotFound();
